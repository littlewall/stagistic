...
type PrepareActsAndScenesCaptureArgs = {
...
export const prepareActsAndScenesCapture = async ({
    page,
    baseUrl,
}: PrepareActsAndScenesCaptureArgs): Promise<void> => {
    const demoUrl = new URL('/dev/demos/acts-and-scenes', baseUrl).toString();
