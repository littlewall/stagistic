...
describe('runEditorBlocksFlow', () => {
    it('writes the approved block sequence through real keyboard-oriented driver actions', async () => {
        ...
        expect(events).toEqual([
            ['typeHuman', 'THE ROOFTOP'],
            ['moveToBlock', 'demo-stage-direction-1'],
            ['typeHuman', 'A storm gathers over the silent city.'],
            ...
            ['moveToBlock', 'demo-stage-direction-music'],
            ['typeHuman', 'A distant melody rises.'],
            ['typeHuman', '#'],
            ...
            ['typeHuman', 'First light spills over the rooftop.'],
            ['pause', 1_400],
        ]);
    });
});
