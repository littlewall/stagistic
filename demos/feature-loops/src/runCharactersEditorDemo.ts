...
import {createPlaywrightCharactersEditorDriver} from './flows/createPlaywrightCharactersEditorDriver';
import {runRecordedCharactersEditorDemo} from './runner/runRecordedCharactersEditorDemo';
...
const main = async (): Promise<void> => {
    ...
    try {
        ...
        const driver = createPlaywrightCharactersEditorDriver(page);
