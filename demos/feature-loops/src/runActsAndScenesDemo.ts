...
import {createPlaywrightActsAndScenesDriver} from './flows/createPlaywrightActsAndScenesDriver';
import {runRecordedActsAndScenesDemo} from './runner/runRecordedActsAndScenesDemo';
...
const main = async (): Promise<void> => {
    ...
    try {
        ...
        const driver = createPlaywrightActsAndScenesDriver(page);
