...
export type {BlockSettingsPatch, StructureSettingsPatch};

export type PageSettingsPatch = Partial<PageSettings>;

export type UpdateBlockSettings = (blockType: ScriptBlockNodeType, patch: BlockSettingsPatch) => void;
...
export interface ElementNumericModel {
    ...
    sceneNumberFormatOptions?: FormSelectOption[];
}
