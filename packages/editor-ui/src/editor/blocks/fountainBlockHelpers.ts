...
export const isParentheticalSelection = (editor: PlateEditor) =>
  Boolean(
    editor.api.above({
      block: true,
      match: (node) =>
...
export const isCharacterSelection = (editor: PlateEditor) =>
  Boolean(
    editor.api.above({
      block: true,
      match: (node) =>
...
export const isDualCharacterSelection = (editor: PlateEditor) =>
  Boolean(
    editor.api.above({
      block: true,
      match: (node) =>
...
export const isDialogueSelection = (editor: PlateEditor) =>
  Boolean(
    editor.api.above({
      block: true,
      match: (node) =>
...
export const isDualDialogueSelection = (editor: PlateEditor) =>
  Boolean(
    editor.api.above({
      block: true,
      match: (node) =>
...
export const getElementText = (node: FountainElement) =>
...
const isDialogueSectionType = (type: FountainElementType | null) =>
  Boolean(type && dialogueSectionTypes.has(type));
