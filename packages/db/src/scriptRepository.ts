...
export interface ScriptLocationsRepository {
    ...
    replaceSceneAssignments(scriptId: string, sceneHeadingBlockId: string, locationIds: string[]): Promise<string[]>;
}
...
export interface ScriptAttachmentsRepository {
    ...
    setForMusic(scriptId: string, musicId: string, role: MusicAttachmentRole, file: MusicAttachmentUpload): Promise<ScriptMusicAttachment | null>;
...
export interface ScriptRepository {
    ...
    getScriptSceneLocationsSource(scriptId: string): ReactiveQuerySource<ScriptSceneLocationAssignment>;
    ...
    createScriptLocationWithId(scriptId: string, input: CreateScriptLocationWithIdInput): Promise<ScriptLocation | null>;
    ...
    replaceScriptSceneLocations(scriptId: string, sceneHeadingBlockId: string, locationIds: string[]): Promise<string[]>;
    getMusicAttachment(musicId: string, role: MusicAttachmentRole): Promise<ScriptMusicAttachment | null>;
    setMusicAttachment(scriptId: string, musicId: string, role: MusicAttachmentRole, file: MusicAttachmentUpload): Promise<ScriptMusicAttachment | null>;
    ...
    confirmScriptCharacterWithId(scriptId: string, input: ConfirmScriptCharacterWithIdInput): Promise<ScriptCharacterRef | null>;
    ...
    renameScriptCharacterGroup(scriptId: string, groupId: string, key: string): Promise<ScriptCharacterGroupRef | null>;
    setScriptCharacterColor(scriptId: string, characterId: string, colorHex: string | null): Promise<ScriptCharacterRef | null>;
    setScriptCharacterGroupColor(scriptId: string, groupId: string, colorHex: string | null): Promise<ScriptCharacterGroupRef | null>;
    replaceScriptCharacterGroupMembers(scriptId: string, groupId: string, memberIds: string[]): Promise<ScriptCharacterGroupRef | null>;
    ...
    setScriptCharacterVoiceType(scriptId: string, characterId: string, voiceType: string | null): Promise<ScriptCharacterRef | null>;
